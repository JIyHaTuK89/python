# надеюсь я правильно понял условия, они в методичке немного расплывчаты.
products = []
...
# знаю про list(set(some_list)), но решил сделать иначе. Что б скучно не было.
# Хотя лишние проверки это потеря производительности, но все равно
for el in products:
